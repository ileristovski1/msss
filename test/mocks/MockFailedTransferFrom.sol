...
contract MockFailedTransferFrom is ERC20Burnable, Ownable {
    error MacedonianStandard__AmountMustBeMoreThanZero();
    ...
    For example:
    constructor() ERC20("MacedonianStandard", "MKD") Ownable(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266) {}
    Related code changes can be viewed in this commit:
    https://github.com/OpenZeppelin/openzeppelin-contracts/commit/13d5e0466a9855e9305119ed383e54fc913fdc60
    */
    constructor() ERC20("MacedonianStandard", "MKD") {}

    function burn(uint256 _amount) public override onlyOwner {
        uint256 balance = balanceOf(msg.sender);
        if (_amount <= 0) {
            revert MacedonianStandard__AmountMustBeMoreThanZero();
        }
        if (balance < _amount) {
